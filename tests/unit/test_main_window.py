...
class TestMainWindowSignals:
    ...
    def test_signals_connected(self, main_window):
        ...
        with patch.object(main_window, 'browse_directory') as mock_browse:
            main_window.browse_button.click()
            mock_browse.assert_called_once()
    
    def test_query_input_return_pressed(self, main_window):
...
class TestMainWindowResultHandling:
    ...
    def test_on_result_found(self, main_window):
        ...
        main_window.on_result_found(test_path, 1)
        
        assert len(main_window.search_results) == 1
        assert main_window.search_results[0] == test_path
...
class TestMainWindowFileOperations:
    ...
    def test_open_selected_folder_success(self, main_window):
        ...
        with patch('filesearch.ui.main_window.open_containing_folder') as mock_open_folder:
