...
class SecurityManager:
    ...
    def _load_user_preferences(self) -> None:
        ...
        try:
            ...
            allowed = self.config_manager.get(
                "security.allowed_executable_extensions", []
            )
            self._allowed_extensions = set(allowed)

            # Load blocked extensions
            blocked = self.config_manager.get(
                "security.blocked_executable_extensions", []
            )
    ...
    def _save_user_preferences(self) -> None:
        ...
        try:
            ...
            self.config_manager.set(
                "security.allowed_executable_extensions", list(self._allowed_extensions)
            )

            # Save blocked extensions
            self.config_manager.set(
                "security.blocked_executable_extensions", list(self._blocked_extensions)
            )
