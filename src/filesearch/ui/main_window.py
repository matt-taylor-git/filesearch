...
class SearchWorker(QThread):
    ...
    progress_update = pyqtSignal(int, str, int)  # progress_percent, current_dir, files_found
...
class MainWindow(QMainWindow):
    ...
    def setup_ui(self) -> None:
        ...
        self.query_input.setPlaceholderText("Enter search pattern (e.g., *.py, document*)")
    ...
    def start_search(self) -> None:
        ...
        if not directory or not query:
            self.statusBar().showMessage("Please enter both directory and search pattern")
            return
    ...
    def on_progress_update(self, progress: int, current_dir: str, files_found: int) -> None:
        ...
        """
        self.statusBar().showMessage(f"Searching {current_dir}... Found {files_found} files")
    ...
    def on_search_complete(self, total_files: int, total_dirs: int) -> None:
        ...
        logger.info(f"Search completed: {total_files} files in {total_dirs} directories")
    ...
    def on_search_stopped(self, files_found: int, dirs_searched: int) -> None:
        ...
        logger.info(f"Search stopped: {files_found} files in {dirs_searched} directories")
